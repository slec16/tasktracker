...
const IssuesItem = (props: IssuesItemProps) => {
    ...
    const priorityStyles = (priority: string) => {
        switch (priority) {
            ...
            case 'Medium':
                return 'bg-yellow-100 text-yellow-700 border-yellow-300 dark:bg-yellow-800 dark:text-yellow-200 dark:border-yellow-600'
            case 'High':
                return 'bg-red-100 text-red-700 border-red-300 dark:bg-red-800 dark:text-red-200 dark:border-red-600'
            default:
                return 'bg-gray-100 text-gray-700 border-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600'
        }
    }
