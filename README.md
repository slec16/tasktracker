...
Приложение для управления задачами с поддержкой kanban-досок. 
...
1. **Виртуализация доски и drag-and-drop** — в `Board.tsx` есть TODO: виртуализация таблицы доски
...
3. **Мониторинг ошибок** — нет интеграции с Sentry
